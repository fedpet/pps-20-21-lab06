...
import u06lab.solution.StringExtensions.ExtendedString
...
class TryParsers {
  ...
  /** linearisation of parserNTCNE:
   *  AnonClass (parserNTCNE) -> NotTwoConsecutive -> NonEmpty -> BasicParser -> Parser -> AnyRef -> Any
   */
